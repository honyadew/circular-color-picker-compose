...
internal fun HarmonyColorMagnifiers(
    ...
    primaryMagnifierBorderColor: Color,
    additionalMagnifierBorderColor: Color,
    ) {
    ...
    hsvColor.getColors(harmonyMode).forEach { color ->
        ...
        Magnifier(position = positionForColor.value, color = color, diameter = diameterDp * diameterHarmonyColor, additionalMagnifierBorderColor)
    }
    Magnifier(position = positionAnimated.value, color = hsvColor, diameter = animatedDiameter.value, primaryMagnifierBorderColor)
}
